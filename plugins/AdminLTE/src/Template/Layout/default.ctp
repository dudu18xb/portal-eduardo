...
<head>
    ...
    <!-- fancybox -->
    <?php echo $this->Html->css('AdminLTE./css/fancybox'); ?>
    <?php echo $this->Html->css('AdminLTE./css/estilo'); ?>
...
<!-- Fancybox -->
<?php echo $this->Html->script('AdminLTE./js/fancybox.umd'); ?>
<?php echo $this->Html->script('AdminLTE./js/jquery.mask'); ?>

<?php echo $this->Html->script('AdminLTE./js/js-default'); ?>
