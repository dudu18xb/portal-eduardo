<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li>
            <?= $this->Html->link('<i class="fa fa-arrow-left"></i> ' . __('Voltar'), ['controller'=> 'Blogs','action' => 'edit',$idblog], ['escape' => false, 'class' => 'btn btn-danger text-white btn-sm']) ?>
        </li>
    </ol>
</section>
                                            ...
                                            <a href="/files/Fotos/imagem/<?php echo $fotoblog->imagem; ?>" data-fancybox="images"
                                               data-caption="<?= h($fotoblog->descricao) ?>">
                                                <img src="/files/Fotos/imagem/<?php echo $fotoblog->imagem; ?>"
                                                     alt='<?= h($fotoblog->descricao) ?>' class='img-thumb'>
                                            </a>
                                        </td>
                                        <td class="actions" style="white-space:nowrap">
                                            <?= $this->Html->link(__('Editar'), ['action' => 'editblog',$idblog, $fotoblog->id], ['class'=>'btn btn-warning btn-xs']) ?>
                                            <?= $this->Form->postLink(__('Excluir'), ['action' => 'deleteblog',$idblog, $fotoblog->id], ['confirm' => __('Deseja mesmo Excluir'), 'class'=>'btn btn-danger btn-xs']) ?>
                                        </td>
                                    </tr>
                                    </tbody>
                                <?php } ?>
