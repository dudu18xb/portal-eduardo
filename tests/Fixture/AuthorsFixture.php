...
class AuthorsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'authors_ibfk_1' => ['type' => 'foreign', 'columns' => ['seo_id'], 'references' => ['seos', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2022-10-26 23:42:42',
                'visualization' => 'Lorem ipsum dolor sit amet',
                'modified' => '2022-10-26 23:42:42',
                'seo_id' => 1
            ],
        ];
        parent::init();
