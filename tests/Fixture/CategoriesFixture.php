...
class CategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'categories_ibfk_1' => ['type' => 'foreign', 'columns' => ['seo_id'], 'references' => ['seos', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2022-10-26 23:44:13',
                'modified' => '2022-10-26 23:44:13'
            ],
        ];
        parent::init();
    }
