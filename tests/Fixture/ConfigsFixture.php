...
class ConfigsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'celular' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-12-03 21:22:58',
                'modified' => '2018-12-03 21:22:58'
            ],
        ];
        parent::init();
    }
