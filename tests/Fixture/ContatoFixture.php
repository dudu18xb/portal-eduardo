...
class ContatoFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'assunto' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'mensagem' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-02-23 22:53:00',
                'modified' => '2019-02-23 22:53:00'
            ],
        ];
        parent::init();
    }
