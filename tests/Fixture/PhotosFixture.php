...
class PhotosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'page_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'page_id' => ['type' => 'index', 'columns' => ['page_id'], 'length' => []],
            'article_id' => ['type' => 'index', 'columns' => ['article_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'photos_ibfk_1' => ['type' => 'foreign', 'columns' => ['page_id'], 'references' => ['pages', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'photos_ibfk_2' => ['type' => 'foreign', 'columns' => ['article_id'], 'references' => ['articles', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2022-10-26 23:45:30',
                'modified' => '2022-10-26 23:45:30'
            ],
        ];
        parent::init();
    }
