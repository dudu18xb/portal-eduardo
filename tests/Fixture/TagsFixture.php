...
class TagsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'tags_ibfk_1' => ['type' => 'foreign', 'columns' => ['seo_id'], 'references' => ['seos', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2022-10-26 23:46:08',
                'modified' => '2022-10-26 23:46:08',
                'seo_id' => 1
            ],
        ];
        parent::init();
